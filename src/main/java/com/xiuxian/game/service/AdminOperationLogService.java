...
import com.xiuxian.game.entity.AdminOperationLog;
import com.xiuxian.game.mapper.AdminOperationLogMapper;
...
public class AdminOperationLogService {
    ...
    public void recordOperation(Integer adminId, String operationType, String targetType, 
        ...
        try {
            ...
            log.info("记录管理员操作日志: adminId={}, operation={}, target={}:{}", 
                    adminId, operationType, targetType, targetId);
        } catch (Exception e) {
            log.error("记录管理员操作日志失败: adminId={}, operation={}", adminId, operationType, e);
        }
    }
    ...
    public void cleanExpiredLogs() {
        try {
            ...
            log.info("清理过期管理员操作日志: {} 条", deletedCount);
        } catch (Exception e) {
            log.error("清理过期管理员操作日志失败", e);
        }
    }
