 ...
 * 游戏平衡配置
 * 
 * 根据GDD占位符数值和游戏实测数据调整的游戏平衡参数
 * 所有数值均可通过application.yml或环境变量覆盖，便于热更新
 * 
 * @author shaun.sheng
 * @version 1.0
 * @since 2026-03-24
...
public class GameBalanceConfig {
    ...
    public static class CultivationBalanceConfig {
        /**
         * 修炼基础灵石/时 = base_spirit_stones + level * 5
         ...
         * 境界修炼加成倍率
         */
        private double realmBonusQiCondensation = 1.0;  // 练气期
        private double realmBonusFoundation = 1.5;       // 筑基期
        private double realmBonusGoldenCore = 2.5;      // 金丹期
        private double realmBonusNascentSoul = 4.0;     // 元婴期
