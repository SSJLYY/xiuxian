...
public class GameMap {
    ...
    /** 怪物配置列表 */
    @TableField(exist = false)
    private java.util.List<MapMonster> monsters;
    
    /**
     * 地图类型枚举
     */
    public static class MapType {
        public static final String SAFE = "SAFE";           // 安全�?
        public static final String NORMAL = "NORMAL";       // 普通区
        public static final String DANGEROUS = "DANGEROUS"; // 危险�?
        public static final String DUNGEON = "DUNGEON";     // 副本
        public static final String BOSS = "BOSS";           // BOSS�?
    }
