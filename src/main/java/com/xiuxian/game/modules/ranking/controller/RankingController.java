package com.xiuxian.game.modules.ranking.controller;

import com.xiuxian.game.dto.response.ApiResponse;
import com.xiuxian.game.modules.player.entity.PlayerProfile;
import com.xiuxian.game.modules.ranking.entity.Ranking;
import com.xiuxian.game.modules.player.service.PlayerService;
import com.xiuxian.game.modules.ranking.service.RankingService;
...
public class RankingController {
    ...
    public ApiResponse<List<Ranking>> getLevelRanking(
        ...
        try {
            log.info("获取等级排行�? page={}, size={}", page, size);
            ...
            log.error("获取等级排行榜失�?, e);
            return ApiResponse.error("获取排行榜失�? " + e.getMessage());
        }
    }
    ...
    public ApiResponse<Map<String, Object>> getMyRank(
        ...
        try {
            ...
            result.put("rank", rank != null ? rank : "未上�?);
    ...
    public ApiResponse<List<Ranking>> getRankingList(
        ...
        try {
            log.info("获取排行�? type={}, limit={}", type, limit);
