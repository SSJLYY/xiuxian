 ...
 * 所有公式都基于GameBalanceConfig配置，便于调优
 * 
 * @author shaun.sheng
 * @version 1.0
 * @since 2026-03-24
...
public class GameBalanceUtils {
    ...
    public int calculateDropSpiritStones(int monsterLevel, String monsterType, int playerLevel) {
        ...
        double levelDiffFactor = 1.0 + levelDiff * 0.1; // 每级差10%
        levelDiffFactor = Math.max(0.5, Math.min(2.0, levelDiffFactor)); // 限制在0.5-2.0倍
