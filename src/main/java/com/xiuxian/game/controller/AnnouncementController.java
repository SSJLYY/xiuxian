...
public class AnnouncementController {
     ...
     * <ul>
     *   <li>公告标题</li>
     *   <li>公告类型（系统/维护/活动/更新）</li>
     *   <li>优先级（0-普通 1-重要 2-紧急）</li>
     *   <li>显示类型（弹窗/滚动/列表）</li>
     *   <li>开始时间和结束时间</li>
     * </ul>
     * 
     * <p>只返回状态为"已发布"且在有效期内的公告。</p>
     * 
     * @return 有效公告列表
     */
    @GetMapping("/list")
    ...
    public ResponseEntity<ApiResponse<Announcement>> getLatestAnnouncement() {
        try {
            ...
            log.debug("获取最新公告: playerId={}", playerId);
            
            Announcement announcement = announcementService.getLatestAnnouncement();
            
            log.debug("获取最新公告成功: playerId={}, announcementId={}", 
