 ...
 * 
 * // 记录业务操作
 * LogUtils.logBusiness("CULTIVATION", "玩家开始修�?, "playerId", 123);
 * 
 * // 结束链路追踪
 * LogUtils.endTrace();
 * }</pre>
...
public class LogUtils {
    ...
    public static void setUserContext(String userId, Integer playerId) {
        ...
        log.debug("设置用户上下�? userId={}, playerId={}", userId, playerId);
    }
    ...
    public static void logDatabase(String operation, String table, long duration, int rowCount) {
        ...
        String message = String.format("数据库操�?- 操作: %s, �? %s, 耗时: %dms, 影响行数: %d", 
