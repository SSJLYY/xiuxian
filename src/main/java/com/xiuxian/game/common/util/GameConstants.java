...
public class GameConstants {
    ...
    public static final int REALM_CHANGE_INTERVAL = 100; // �?00级提升一个境�?
    ...
    // 错误消息
    public static final String ERROR_PLAYER_NOT_FOUND = "玩家不存�?;
    public static final String ERROR_INSUFFICIENT_RESOURCES = "资源不足";
    public static final String ERROR_INVALID_OPERATION = "无效操作";
    public static final String ERROR_ITEM_NOT_FOUND = "物品不存�?;
    public static final String ERROR_SKILL_NOT_FOUND = "技能不存在";
    public static final String ERROR_EQUIPMENT_NOT_FOUND = "装备不存�?;
    public static final String ERROR_QUEST_NOT_FOUND = "任务不存�?;
    public static final String ERROR_ALREADY_COMPLETED = "已完�?;
    public static final String ERROR_REQUIREMENTS_NOT_MET = "条件不满�?;
    ...
    public static final String SUCCESS_SKILL_LEARNED = "技能学习成�?;
    public static final String SUCCESS_SKILL_UPGRADED = "技能升级成�?;
