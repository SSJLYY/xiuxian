...
export class QuestService {
    ...
    async getQuestList(type = 'all') {
        try {
            const response = await gameAPI.getQuests(type);
            if (response.success) {
    ...
    async getMyQuests() {
        try {
            const response = await gameAPI.getMyQuests();
            if (response.success) {
    ...
    async acceptQuest(questId) {
        try {
            const response = await gameAPI.acceptQuest(questId);
            if (response.success) {
    ...
    async completeQuest(questId) {
        try {
            const response = await gameAPI.completeQuest(questId);
            if (response.success) {
